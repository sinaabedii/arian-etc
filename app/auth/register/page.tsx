...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Register Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-neutral-50 via-white to-primary-50 overflow-y-auto">
              ...
              <div>
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-4 h-4 text-primary-600 focus:ring-primary-500 border-neutral-300 rounded mt-1"
                  />
                  <label htmlFor="acceptTerms" className="mr-2 block text-sm text-neutral-700">
                    <Link href="/terms" className="text-primary-600 hover:text-primary-500 underline-offset-4 hover:underline">
                      قوانین و مقررات
                    </Link>{' '}
                    و{' '}
                    <Link href="/privacy" className="text-primary-600 hover:text-primary-500 underline-offset-4 hover:underline">
                      حریم خصوصی
                    </Link>{' '}
